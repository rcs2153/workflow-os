...
pub use work_report::{
    ...
    ApprovalProofMarkerAuditProjectionRecord, ApprovalProofMarkerAuditProjectionResult,
    ApprovalProofMarkerAuditStatus, ApprovalProofMarkerCitationInput,
    ApprovalProofMarkerCitationResult, GitHubPullRequestCommentProviderEventProofRecoveryInput,
