...
use workflow_core::{
    ...
    GovernanceAssessmentBindingVersion, GovernanceDecisionAuthorityReceipt,
...
// Caller-authored authority route tests retired with the preview API surface.
    ...
    let request = LocalExecutionWithAuthoritativeDocsCheckGovernanceRequest {
        ...
        runtime_facts: vec![
            StepGovernanceRuntimeFacts::new(
                ...
                Some(GovernanceWorkloadAuthorityPosture::Sufficient),
                None,
                Some(GovernanceWorkloadSideEffectPosture::ReadOnly),
                None,
                None,
                None,
            ),
