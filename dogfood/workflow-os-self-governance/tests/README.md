...
The implementation, maintainer review, and PR hygiene dogfood workflows are currently covered by project validation. They are governed checklist workflows only: they do not run git commands, inspect GitHub, resolve conflicts, push branches, open PRs, execute arbitrary commands, or replace maintainer review.
