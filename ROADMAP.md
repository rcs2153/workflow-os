...
- provider report artifact event-proof gate planning: [GitHub PR Comment Provider Report Artifact Event-Proof Gate Plan](docs/implementation-plans/github-pr-comment-provider-report-artifact-event-proof-gate-plan.md);
