...
with review documented in [High-Assurance Approval-Resume Artifact Projection
Hardening Review](../concepts/HIGH_ASSURANCE_APPROVAL_RESUME_ARTIFACT_PROJECTION_HARDENING_REVIEW.md).
