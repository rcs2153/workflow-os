...
This plan does not implement writes, write-capable adapters, side-effect events, rollback, compensation, generic live adapter execution, automatic SideEffect discovery, or runtime side-effect execution. Terminal helper and executor SideEffect ID propagation are implemented separately.
