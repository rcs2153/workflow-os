...
Side-effect boundary architecture is proposed in [ADR 0011: Side-Effect Boundary Core Model](../adr/0011-side-effect-boundary.md). ADR 0011 is proposed only; it does not implement the side-effect core model, writes, provider mutations, persistence, schemas, CLI behavior, examples, hosted behavior, or release posture changes.
